...
import { categoryFetch, categoryAdd } from '../ActionCategory';
import { CATEGORYSUCESS, CATEGORYFAIL } from '../ConfigCategory';
import { Link } from 'react-router-dom';

class CategoryAdd extends Component<any, any> {
          ...
          <CardBody>
            <Form action="" method="post" encType="multipart/form-data" className="form-horizontal">
              <FormGroup row>
                ...
                <Col xs="12" md="9">
                  <Input type="text" id="text-input" name="code" onChange={this.onChange} value={this.state.code === null ? '' : this.state.code}  placeholder="CATEGORY Code" />
                </Col>
              </FormGroup>
              <FormGroup row>
                <Col md="3">
...
const mapDispatchToProps = (dispatch: any) => ({
  ...
  onSubmit: (value: object) => dispatch(categoryAdd(value)),
});
