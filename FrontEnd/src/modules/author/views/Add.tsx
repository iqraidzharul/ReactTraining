...
import { authorFetch, authorAdd } from '../ActionAuthor';
import { AUTHORSUCESS, AUTHORFAIL } from '../ConfigAuthor';
import { Link } from 'react-router-dom';

class AUTHORAdd extends Component<any, any> {
          ...
          <CardBody>
            <Form action="" method="post" encType="multipart/form-data" className="form-horizontal">
              <FormGroup row>
                ...
                <Col xs="12" md="9">
                  <Input type="text" id="text-input" name="code" onChange={this.onChange} value={this.state.code === null ? '' : this.state.code}  placeholder="AUTHOR Code" />
                </Col>
              </FormGroup>
              <FormGroup row>
                <Col md="3">
...
const mapDispatchToProps = (dispatch: any) => ({
  ...
  onSubmit: (value: object) => dispatch(authorAdd(value)),
});
